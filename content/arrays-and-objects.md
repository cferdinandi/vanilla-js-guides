...
- How to get specific items from arrays and objects.
- How to loop over arrays and objects.
- How to add and remove items from arrays and objects.
- How to transform arrays and objects using modern ES5 and ES6 methods.
- What immutability is, why it matters, and how to handle it with vanilla JS.
